...
extension UIView {
    ...
    func pin(to superview: UIView, _ sides: [PinSide] = [.top, .bottom, .left, .right], const: Int = 0) {
        for side in sides {
            switch side {
            case .top:
...
final class ViewController: UIViewController {
    ...
    private func setupMenuButtons() {
        ...
        colorsButton.addTarget(self, action: #selector(notesButtonPressed), for: .touchUpInside)
